...
public class Role extends CachedData {
  ...
  public static List<Role> accessQuery(
                                       final SynchronizedEveAccount owner,
                                       final long contid,
                                       ...
                                       final AttributeSelector roleDescription,
    ...
    try {
      return EveKitUserAccountProvider.getFactory().runTransaction(new RunInTransaction<List<Role>>() {
        ...
        public List<Role> run() throws Exception {
          ...
          qs.append("SELECT c FROM Role c WHERE ");
          ...
          AttributeSelector.addStringSelector(qs, "c", "roleDescription", roleDescription, p);
          ...
          // Return result
          TypedQuery<Role> query = EveKitUserAccountProvider.getFactory().getEntityManager().createQuery(qs.toString(), Role.class);
