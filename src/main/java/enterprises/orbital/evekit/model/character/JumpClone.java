...
@Entity
@Table(name = "evekit_data_jump_clone", indexes = {
    @Index(name = "jumpCloneIDIndex", columnList = "jumpCloneID", unique = false),
})
@NamedQueries({
    @NamedQuery(
...
public class JumpClone extends CachedData {
  ...
  public static JumpClone get(final SynchronizedEveAccount owner, final long time, final int jumpCloneID) {
    try {
  ...
  public static List<JumpClone> getAll(final SynchronizedEveAccount owner, final long time) {
    try {
