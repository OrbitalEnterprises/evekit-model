...
@Entity
@Table(name = "evekit_data_character_title", indexes = {
...
public class CharacterTitle extends CachedData {
  ...
  public static CharacterTitle get(final SynchronizedEveAccount owner, final long time, final long titleID) {
    try {
  ...
  public static List<CharacterTitle> getAllTitles(final SynchronizedEveAccount owner, final long time) {
    try {
