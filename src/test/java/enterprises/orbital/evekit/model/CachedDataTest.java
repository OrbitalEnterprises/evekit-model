  ...
  public void testRemoveAccount()
    ...
    for (int i = 0; i < count; i++) {
      ...
      CachedData next = new CharacterSheet(
          ...
          TestBase.getRandomLong(), TestBase.getRandomText(50), TestBase.getRandomText(50), TestBase.getRandomText(50), TestBase.getRandomText(50),
          TestBase.getRandomLong(), TestBase.getRandomText(50), TestBase.getRandomLong(), TestBase.getRandomInt(), TestBase.getRandomInt(),
    ...
    for (int i = 0; i < count; i++) {
      ...
      CachedData next = new UpcomingCalendarEvent(
          ...
          TestBase.getRandomLong(), TestBase.getRandomText(50), TestBase.getRandomText(50), TestBase.getRandomBoolean());
      for (int j = 0; j < sel; j++) {
        next.setMetaData(TestBase.getRandomText(30), TestBase.getRandomText(30));
      }
      next.setup(testAccount, testTime);
    ...
    for (int i = 0; i < count; i++) {
      ...
      CachedData next = new WalletJournal(
          ...
          TestBase.getRandomBigDecimal(100000000), TestBase.getRandomBigDecimal(100000000), TestBase.getRandomText(50), TestBase.getRandomLong(),
    ...
    for (int i = 0; i < count; i++) {
      ...
      CachedData next = new ContainerLog(
          ...
          TestBase.getRandomLong(), TestBase.getRandomLong(), TestBase.getRandomInt(), TestBase.getRandomInt(), TestBase.getRandomInt(),
    ...
    CachedData.cleanup(testAccount);
